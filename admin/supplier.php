            ...
            if ($_SESSION['errorAdd'] == true){
                ?>
                    <script>
                        swal({
                            icon: "error",
                            title: "Supplier name you entered already exist!",
                        }).then((value) => {
                            ...
                            if(mysqli_num_rows($resultSup) > 0){
                                ...
                                while($rowSup = mysqli_fetch_assoc($resultSup)){
                                    ...
                                    ?>
                                        <tr>
                                            <td><?php echo $x; ?></td>
                                            <td><?php echo ucwords($rowSup['sup_name']); ?></td>
                                            <td><?php echo ucwords($rowSup['sup_cont_num']); ?></td>
                                            <td>
                                                <button class="btnEdit" id="<?php echo $rowSup['sup_id']; ?>" data-id="<?php echo $rowSup['sup_id']; ?>" data-name="<?php echo ucwords($rowSup['sup_name']); ?>" data-cont="<?php echo $rowSup['sup_cont_num']; ?>">
                                                ...
                                                <button class="btnDelete" id="<?php echo $rowSup['sup_id']; ?>" data-id="<?php echo $rowSup['sup_id']; ?>" data-name="<?php echo ucwords($rowSup['sup_name']); ?>">
            ...
            <form id="formAE" action="" method="POST" class="content-con">
                <div class="row">
                    ...
                    <div class="col-6">
                        ...
                        <input class="form-control" id="supName" name="supName" type="text" required autocomplete="off">
                    </div>
                </div>
                <div class="row">
                    <div class="col-6">
                    ...
                    <div class="col-6">
                        <input class="form-control" id="supCon" name="supCon" type="number" required autocomplete="off">
                    </div>
                </div>
                <div class="row">
        ...
        <div class="inner-modal">
            ...
            <form class="content-con" action="./supplier-delete.php" method="POST">
                <div class="row">
                    ...
                    <div class="col-6">
                        <input type="hidden" id="delSupId" name="delSupId">
                        <span id="delSupName"></span>
                    </div>
                </div>
                <div class="row">
                    <div class="btnCol col-6">
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            $('.btnAdd').click(function(){
                ...
                $('.modal-title-con').html('ADD SUPPLIER');
                $('#formAE').prop('action', 'supplier-add.php');
                $('#supName').focus();
            });
            ...
            $('.btnEdit').click(function(){
                ...
                $('#supCon').val(supCon);
                $('#supName').focus();
                $('#formAE').prop('action', 'supplier-edit.php');
            });
